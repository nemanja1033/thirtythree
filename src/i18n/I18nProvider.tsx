...
const dictEn: Dict = {
  ...
  "flatburger.badge": "Portfolio Case Study",
  "flatburger.title": "FlatBurger",
  "flatburger.subtitle": "Modern Fast Food Brand Identity & Web Experience",
  "flatburger.overview.title": "Project Overview",
  "flatburger.overview.desc": "FlatBurger approached us to create a fresh, modern brand identity and digital presence that would stand out in the competitive fast food market. The goal was to combine a playful, approachable brand personality with a premium digital experience.",
  "flatburger.challenge.title": "The Challenge",
  "flatburger.challenge.desc": "The fast food industry is saturated with similar brands. FlatBurger needed a unique identity that would resonate with younger audiences while maintaining broad appeal. The challenge was creating a brand that felt both premium and accessible.",
  "flatburger.solution.title": "Our Solution",
  "flatburger.solution.desc": "We developed a bold, geometric brand identity inspired by the flat burger concept itself. The design system uses clean lines, vibrant colors, and playful typography to create a memorable brand experience. The website combines smooth animations with intuitive navigation to showcase the brand's personality.",
  "flatburger.services.title": "Services Provided",
  "flatburger.services.1": "Brand Strategy & Positioning",
  "flatburger.services.2": "Visual Identity Design",
  "flatburger.services.3": "Web Design & Development",
  "flatburger.services.4": "Brand Guidelines",
  "flatburger.results.title": "Results",
  "flatburger.results.1.label": "Brand Recognition",
  "flatburger.results.1.value": "+250%",
  "flatburger.results.1.desc": "Increase in brand awareness within first 6 months",
  "flatburger.results.2.label": "Website Traffic",
  "flatburger.results.2.value": "+180%",
  "flatburger.results.2.desc": "Organic traffic growth after launch",
  "flatburger.results.3.label": "User Engagement",
  "flatburger.results.3.value": "+320%",
  "flatburger.results.3.desc": "Increase in average session duration",
  "flatburger.tech.title": "Technologies Used",
  "flatburger.tech.1": "React & TypeScript",
  "flatburger.tech.2": "Framer Motion",
  "flatburger.tech.3": "TailwindCSS",
  "flatburger.tech.4": "Vite",
  "flatburger.cta.title": "Ready to Transform Your Brand?",
  "flatburger.cta.desc": "Let's discuss how we can help bring your vision to life",
  "flatburger.cta.button": "Start Your Project",
};
...
const dictSr: Dict = {
  ...
  // FlatBurger Portfolio Page
  "flatburger.badge": "Portfolio Studija Slučaja",
  "flatburger.title": "FlatBurger",
  "flatburger.subtitle": "Moderna Identitet Brenda Brze Hrane i Web Iskustvo",
  "flatburger.overview.title": "Pregled Projekta",
  "flatburger.overview.desc": "FlatBurger nam se obratio da kreiramo svež, moderan identitet brenda i digitalno prisustvo koje će se istaknuti na konkurentnom tržištu brze hrane. Cilj je bio kombinovati razigranu, pristupačnu ličnost brenda sa premium digitalnim iskustvom.",
  "flatburger.challenge.title": "Izazov",
  "flatburger.challenge.desc": "Industrija brze hrane je zasićena sličnim brendovima. FlatBurger je trebao jedinstven identitet koji će odjekivati kod mlađe publike, zadržavajući široku privlačnost. Izazov je bio kreirati brend koji oseća i premium i pristupačno.",
  "flatburger.solution.title": "Naše Rešenje",
  "flatburger.solution.desc": "Razvili smo hrabar, geometrijski identitet brenda inspirisan samim konceptom flat burgera. Dizajn sistem koristi čiste linije, živahne boje i razigranu tipografiju da kreira nezaboravno iskustvo brenda. Sajt kombinuje glatke animacije sa intuitivnom navigacijom da prikaže ličnost brenda.",
  "flatburger.services.title": "Pružene Usluge",
  "flatburger.services.1": "Strategija Brenda i Pozicioniranje",
  "flatburger.services.2": "Dizajn Vizuelnog Identiteta",
  "flatburger.services.3": "Web Dizajn i Razvoj",
  "flatburger.services.4": "Smernice Brenda",
  "flatburger.results.title": "Rezultati",
  "flatburger.results.1.label": "Prepoznatljivost Brenda",
  "flatburger.results.1.value": "+250%",
  "flatburger.results.1.desc": "Povećanje svesti o brendu u prvih 6 meseci",
  "flatburger.results.2.label": "Saobraćaj Sajta",
  "flatburger.results.2.value": "+180%",
  "flatburger.results.2.desc": "Rast organskog saobraćaja nakon lansiranja",
  "flatburger.results.3.label": "Angažovanje Korisnika",
  "flatburger.results.3.value": "+320%",
  "flatburger.results.3.desc": "Povećanje prosečnog trajanja sesije",
  "flatburger.tech.title": "Korišćene Tehnologije",
  "flatburger.tech.1": "React & TypeScript",
  "flatburger.tech.2": "Framer Motion",
  "flatburger.tech.3": "TailwindCSS",
  "flatburger.tech.4": "Vite",
  "flatburger.cta.title": "Spremni da Transformišete Svoj Brend?",
  "flatburger.cta.desc": "Hajde da razgovaramo kako možemo pomoći da oživite svoju viziju",
  "flatburger.cta.button": "Započni Projekat",
};
