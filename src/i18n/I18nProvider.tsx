...
const dictEn: Dict = {
  ...
  "flatburger.digitalDesc": "Building a digital presence that matches the brand's energy.",
  "flatburger.digitalDeliverables": "Website Design,Social Assets,Digital Applications",
...
const dictSr: Dict = {
  ...
  "flatburger.digitalDesc": "Gradnja digitalnog prisustva koje odgovara energiji brenda.",
  "flatburger.digitalDeliverables": "Dizajn Sajta,Društvene Mreže,Digitalne Aplikacije",
