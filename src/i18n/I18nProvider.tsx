...
const dictEn: Dict = {
  ...
  "norma.concept.label": "Concept",
  "norma.concept.headline":
    "A studio built on structure, proportion, and disciplined calm.",
  "norma.concept.body":
    "NORMA treats space as a system. The brand is strict but warm, with a quiet authority that frames each project without noise or excess.",
  "norma.concept.blockTitle": "Design stance",
  "norma.concept.one.title": "Clarity over noise",
  "norma.concept.one.body": "Every element earns its place and purpose.",
  "norma.concept.two.title": "Grid as language",
  "norma.concept.two.body": "Alignment and spacing become the tone of voice.",
  "norma.concept.three.title": "Quiet confidence",
  "norma.concept.three.body": "Typography stays restrained and architectural.",
  "norma.identity.logoSystem": "Logo system",
  "norma.identity.signature": "Primary / Secondary",
  "norma.identity.lockup": "Secondary lockup",
  "norma.identity.studio": "ARCHITECTURE + DESIGN",
  "norma.identity.body":
    "A condensed wordmark balances weight and spacing to mirror architectural proportion.",
  "norma.identity.typography": "Typography",
  "norma.identity.headline": "Structure before ornament.",
  "norma.identity.bodyCopy":
    "Editorial hierarchy with strong contrast and generous negative space keeps the work quiet and deliberate.",
  "norma.identity.detail1": "Condensed display",
  "norma.identity.detail2": "Neutral sans",
  "norma.applications.portfolio": "Portfolio layouts",
  "norma.applications.project.one.title": "Civic Hall Renovation",
  "norma.applications.project.one.meta": "Public",
  "norma.applications.project.two.title": "Gallery Wing Expansion",
  "norma.applications.project.two.meta": "Culture",
  "norma.applications.project.three.title": "Residential Atrium",
  "norma.applications.project.three.meta": "Residential",
  "norma.applications.project.four.title": "Studio Archive",
  "norma.applications.project.four.meta": "Practice",
  "norma.applications.wallMark": "Wall mark",
  "norma.applications.wallBody":
    "A quiet typographic mark for studio interiors and project rooms.",
  "norma.poster.one.title": "Measured light. Calm structure.",
  "norma.poster.one.body": "Posters communicate the studio stance in public exhibitions.",
  "norma.poster.two.title": "Architecture as quiet order.",
  "norma.poster.two.body": "Printed matter keeps the identity minimal and authoritative.",
  "norma.digital.title": "Digital experience",
  "norma.digital.screen1.label": "Homepage",
  "norma.digital.screen1.title": "Selected works and spatial studies.",
  "norma.digital.screen1.body":
    "A calm grid of projects with restrained typography and clear hierarchy.",
  "norma.digital.screen2.label": "Project detail",
  "norma.digital.screen2.title": "Material palette and process notes.",
  "norma.digital.screen2.body":
    "Project pages focus on proportions, drawings, and studio intent.",
  "norma.digital.tag1": "Projects",
  "norma.digital.tag2": "Studio",
  "norma.digital.tag3": "Contact",
  "norma.digital.tag4": "Plan",
  "norma.digital.tag5": "Materials",
  "norma.digital.tag6": "Process",
...
const dictSr: Dict = {
  ...
  "norma.concept.label": "Koncept",
  "norma.concept.headline":
    "Studio izgrađen na strukturi, proporciji i disciplinovanoj smirenosti.",
  "norma.concept.body":
    "NORMA tretira prostor kao sistem. Brend je strog ali topao, sa tihim autoritetom koji uokviruje projekte bez buke.",
  "norma.concept.blockTitle": "Dizajnerski stav",
  "norma.concept.one.title": "Jasnoća bez buke",
  "norma.concept.one.body": "Svaki element ima mesto i svrhu.",
  "norma.concept.two.title": "Grid kao jezik",
  "norma.concept.two.body": "Poravnanje i razmaci postaju ton.",
  "norma.concept.three.title": "Tiha sigurnost",
  "norma.concept.three.body": "Tipografija ostaje uzdržana i arhitektonska.",
  "norma.identity.logoSystem": "Sistem logotipa",
  "norma.identity.signature": "Primarni / sekundarni",
  "norma.identity.lockup": "Sekundarna verzija",
  "norma.identity.studio": "ARHITEKTURA + DIZAJN",
  "norma.identity.body":
    "Kompaktni logotip balansira težinu i razmake u skladu sa proporcijom.",
  "norma.identity.typography": "Tipografija",
  "norma.identity.headline": "Struktura pre ukrasa.",
  "norma.identity.bodyCopy":
    "Editorial hijerarhija sa snažnim kontrastom i velikim belinama drži rad mirnim i promišljenim.",
  "norma.identity.detail1": "Kondenzovani display",
  "norma.identity.detail2": "Neutralni sans",
  "norma.applications.portfolio": "Portfolio rasporedi",
  "norma.applications.project.one.title": "Renovacija gradske hale",
  "norma.applications.project.one.meta": "Javno",
  "norma.applications.project.two.title": "Proširenje galerijskog krila",
  "norma.applications.project.two.meta": "Kultura",
  "norma.applications.project.three.title": "Stambeni atrijum",
  "norma.applications.project.three.meta": "Stambeno",
  "norma.applications.project.four.title": "Arhiva studija",
  "norma.applications.project.four.meta": "Praksa",
  "norma.applications.wallMark": "Zidni znak",
  "norma.applications.wallBody":
    "Tih tipografski znak za enterijere studija i projektne sale.",
  "norma.poster.one.title": "Merena svetlost. Mirna struktura.",
  "norma.poster.one.body": "Posteri komuniciraju stav studija u javnim izložbama.",
  "norma.poster.two.title": "Arhitektura kao tihi red.",
  "norma.poster.two.body": "Štampani materijali drže identitet minimalnim i autoritativnim.",
  "norma.digital.title": "Digitalno iskustvo",
  "norma.digital.screen1.label": "Početna",
  "norma.digital.screen1.title": "Odabrani radovi i prostorne studije.",
  "norma.digital.screen1.body":
    "Smiren grid projekata sa uzdržanom tipografijom i jasnom hijerarhijom.",
  "norma.digital.screen2.label": "Projektna stranica",
  "norma.digital.screen2.title": "Materijalna paleta i beleške procesa.",
  "norma.digital.screen2.body":
    "Stranice projekata fokusiraju proporcije, crteže i nameru studija.",
  "norma.digital.tag1": "Projekti",
  "norma.digital.tag2": "Studio",
  "norma.digital.tag3": "Kontakt",
  "norma.digital.tag4": "Plan",
  "norma.digital.tag5": "Materijali",
  "norma.digital.tag6": "Proces",
