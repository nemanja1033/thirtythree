...
function ProjectLine({ title, meta, body }: { title: string; meta: string; body: string }) {
  return (
    <div className="border-b py-6" style={{ borderColor: LINE }}>
...
function EditorialSheet({ label, title, body }: { label: string; title: string; body: string }) {
  return (
      ...
      <section ref={openingRef} className="pt-24 md:pt-32 pb-16 md:pb-20">
        <div className="container mx-auto px-6 md:px-8">
          <motion.div
            ...
            animate={openingInView ? { opacity: 1, y: 0 } : {}}
      ...
      <section ref={philosophyRef} className="py-16 md:py-24 border-t" style={{ borderColor: LINE }}>
        <div className="container mx-auto px-6 md:px-8">
          ...
          >
            ...
            <div className="space-y-6 text-sm md:text-base" style={{ color: MUTED }}>
