...
// Flat Burger Logo - Centered and properly aligned SVG
function FlatBurgerLogo({ 
  ...
  // The actual content bounds are: x=48 to x=464, y=97 to y=433
  // Centering this in a square viewBox with proper padding
  return (
    <svg
      width={size}
      height={size}
      viewBox="30 55 450 400"
      className={className}
      style={{ display: 'block' }}
            ...
            <div className="flex flex-col-reverse lg:flex-row lg:items-center lg:justify-between gap-8 lg:gap-16">
              ...
              >
                ...
                <motion.div
                  ...
                  className="relative z-10 w-[140px] h-[140px] md:w-[200px] md:h-[200px] lg:w-[320px] lg:h-[320px]"
                  style={{ 
                    filter: `drop-shadow(0 0 40px ${FLAT_BLUE}80) drop-shadow(0 0 80px ${FLAT_BLUE}40)` 
                  }}
                >
                  <FlatBurgerLogo size={320} color={OFF_WHITE} className="w-full h-full" />
                </motion.div>
              </motion.div>
            </div>
