          ...
          <div className="max-w-[1400px] mx-auto">
            ...
            >
              <p className="text-lg md:text-xl max-w-lg leading-relaxed opacity-60" style={{ color: OFF_WHITE }}>
                {t("flatburger.description")}
              </p>
              
              <div className="flex gap-10">
                {[
                  { label: t("flatburger.year"), value: "2024" },
                  { label: t("flatburger.services"), value: t("flatburger.branding") },
                  { label: t("flatburger.location"), value: "Belgrade" },
                ].map((item, i) => (
                  <motion.div
                    key={i}
          ...
          >
            <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-16">
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                >
                  <span className="text-sm md:text-base">{t("flatburger.readFullArticle")}</span>
...
function LogoShowcase() {
  ...
  const variants = [
    { bg: OFF_WHITE, logoColor: FLAT_BLUE, textColor: FLAT_BLUE, label: t("flatburger.light") },
    { bg: FLAT_BEIGE, logoColor: DARK_BG, textColor: DARK_BG, label: t("flatburger.brandBeige") },
    { bg: FLAT_BLUE, logoColor: OFF_WHITE, textColor: OFF_WHITE, label: t("flatburger.brandBlue") },
    { bg: DARK_BG, logoColor: FLAT_BEIGE, textColor: FLAT_BEIGE, label: t("flatburger.dark") },
  ];
...
function ProcessSection() {
  ...
  const processSteps: ProcessStep[] = [
    {
      phase: "01",
      title: t("flatburger.discovery"),
      description: t("flatburger.discoveryDesc"),
      deliverables: t("flatburger.discoveryDeliverables").split(","),
    },
    {
      phase: "02",
      title: t("flatburger.identity"),
      description: t("flatburger.identityDesc"),
      deliverables: t("flatburger.identityDeliverables").split(","),
    },
    {
      phase: "03",
      title: t("flatburger.digital"),
      description: t("flatburger.digitalDesc"),
      deliverables: t("flatburger.digitalDeliverables").split(","),
    },
    {
      phase: "04",
      title: t("flatburger.content"),
      description: t("flatburger.contentDesc"),
      deliverables: t("flatburger.contentDeliverables").split(","),
    },
    {
      phase: "05",
      title: t("flatburger.launch"),
      description: t("flatburger.launchDesc"),
      deliverables: t("flatburger.launchDeliverables").split(","),
    },
  ];
      ...
      <div className="container mx-auto px-6 md:px-8 relative z-10">
        <div className="max-w-[1600px] mx-auto">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 md:gap-8 mb-12 md:mb-24">
            ...
            >
              {[
                { value: "100+", label: t("flatburger.posts") },
                { value: "Video", label: t("flatburger.contentLabel") },
              ].map((stat, i) => (
...
function ResultsSection() {
  ...
  const results = [
    { 
      ...
      metric: "Journal.rs", 
      label: t("flatburger.pressFeature"), 
      desc: t("flatburger.pressFeatureDesc") 
    },
    { 
      icon: (
      ...
      label: t("flatburger.instagramLabel"), 
      desc: t("flatburger.instagramActive") 
    },
    { 
      icon: (
        <svg className="w-6 h-6 md:w-8 md:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      metric: "Dečanska 4", 
      label: t("flatburger.location"), 
      desc: t("flatburger.locationDesc") 
    },
  ];
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          >
            ...
            <h2
              ...
              style={{ fontFamily: '"Bricolage Grotesque", sans-serif', color: OFF_WHITE }}
            >
              {t("flatburger.successfullyLaunched")}
            </h2>
          </motion.div>
