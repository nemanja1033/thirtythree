...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Brand identity & visual system",
    tags: [],
    image: "/images/noir-supply-featured.svg",
    featured: false,
    gradient: "from-neutral-800 to-neutral-950",
    color: "#0b0b0c",
    year: "2024",
    client: "Studio Concept",
    link: "/portfolio/noir-supply",
    imageFit: "cover",
    imageBg: "#0b0b0c",
  ...
  },
  {
    ...
    title: "SIGNAL WORKS",
    category: "Studio Concept",
    description: "Digital experience & interaction design",
    tags: [],
    image: "/images/signal-works-featured.svg",
    featured: true,
    gradient: "from-slate-800 to-slate-950",
    color: "#0b1220",
    year: "2024",
    client: "Studio Concept",
    link: "/portfolio/signal-works",
    imageFit: "cover",
    imageBg: "#0b1220",
    imageOverlayClass: "from-black/35 via-black/10 to-transparent",
  },
  {
    ...
    title: "PULSE",
    category: "Studio Concept",
    description: "Creative direction & digital content system",
    tags: [],
    image: "/images/pulse-featured.svg",
    featured: false,
    gradient: "from-fuchsia-600 to-rose-600",
    color: "#0b0b14",
    year: "2024",
    client: "Studio Concept",
    link: "/portfolio/pulse",
    imageFit: "cover",
    imageBg: "#0b0b14",
    imageOverlayClass: "from-black/35 via-black/10 to-transparent",
  },
