...
const projects: Project[] = [
  {
    ...
    tags: ["Branding", "Identity", "Web Design", "Belgrade"],
  ...
  },
  {
    ...
    description: "Modern e-commerce solution with advanced filtering and seamless checkout experience. Built with cutting-edge technology for maximum performance.",
    tags: ["React", "TypeScript", "E-commerce", "Next.js"],
  ...
  },
  {
    ...
    category: "Brand Building",
    description: "Complete brand transformation with modern visual identity and comprehensive brand guidelines. A complete rebrand that elevated the company's market presence.",
    tags: ["Branding", "Design", "Identity", "Strategy"],
  ...
  },
  {
    ...
    category: "Web Development",
    description: "Analytics dashboard with real-time data visualization and interactive charts. Empowering businesses with actionable insights.",
  ...
  },
  {
    ...
    description: "Multi-channel marketing campaign that increased user acquisition by 300%. A data-driven approach to exponential growth.",
    tags: ["Marketing", "Strategy", "Growth", "Analytics"],
  ...
  },
  {
    ...
    category: "Brand Building",
    description: "User-centered mobile app design with intuitive navigation and beautiful UI. A seamless experience that users love.",
  ...
  },
  {
    ...
    category: "Web Development",
    description: "High-performance corporate website with CMS integration and SEO optimization. Built for scale and performance.",
    tags: ["Next.js", "CMS", "SEO", "Performance"],
    image: "https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?w=1200&q=90",
    featured: false,
  ...
  },
  {
    ...
    category: "Growth Strategy",
    description: "Comprehensive social media strategy that boosted engagement by 250%. A complete transformation of their digital presence.",
  ...
  },
  {
    ...
    category: "Brand Building",
    description: "Full-scale product launch with integrated marketing and PR strategy. A launch that made headlines.",
    tags: ["Launch", "PR", "Marketing", "Events"],
  ...
  },
  {
    ...
    category: "Web Development",
    description: "Revolutionary AI platform with machine learning integration. Transforming how businesses operate.",
    tags: ["AI", "ML", "React", "Innovation"],
    image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=1200&q=90",
    featured: false,
    gradient: "from-cyan-500 to-blue-500",
    color: "#06b6d4",
    year: "2024",
    client: "AITech Solutions",
  },
];
